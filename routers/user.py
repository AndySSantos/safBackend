...
@router.delete(
    ...
    response_model=None,
    responses={
        '400': {'model': UsersUserIdDeleteResponse},
        '404': {'model': UsersUserIdDeleteResponse1},
    },
    tags=['user'],
)
def delete_users_user_id(
    user_id: int = Path(..., alias='userId')
) -> Union[None, UsersUserIdDeleteResponse, UsersUserIdDeleteResponse1]:
    """
    delete-users-userId
    """
    pass
...
def post_users_user_id_pictures(
    user_id: int = Path(..., alias='userId'),
    content__type: ContentType5 = Header(..., alias='Content-Type'),
    file: UploadFile = ...,
) -> Union[
    None,
